...
## Taak 02 - POST Formulier met extra velden
...
Je hebt dit gedaan met simpele text-input-fields. Je kunt ook andere input-fields hiervoor gebruiken. Zolang het veld een naam (`name-attribuut`) heeft, kan het worden verstuurd en worden gebruikt als een $_POST variabele.
...
![Eindresultaat](images/reslutaat.png)
